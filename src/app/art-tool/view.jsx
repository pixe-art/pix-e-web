...
function ArtTool() {
    ...
    function mouseClickEvent(event) {
        ...
        ctx.fillStyle = event.button === 2 ? "white" : color;
        ...
        function mouseDragEvent(event) {
            if ((event.buttons === 2 || event.buttons === 1) && mouseCheck) {
                ...
                extra.fillStyle = event.button === 2 ? "white" : color;
 ...
 return(
    <div className="parent" onMouseUp={checkResetEvent}>
        ...
        <div className="content">
            ...
            <Draggable className="draggable" showPicker={showPicker} setShowPicker={setShowPicker}>
                <button className="palette-button">Toggle Color Palette</button>
                    {showPicker && (
